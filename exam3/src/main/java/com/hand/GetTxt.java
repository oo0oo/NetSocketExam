...
public class GetTxt { 
    ...
    private static final String REMOTE_FILE_URL = "http://hq.sinajs.cn/list=sz300170"; 

    private static final String LOCAL_FILE_PATH = "C:/Users/Prince/NetSocketExam/exam3/target.txt"; // 改成你保存 文件的路径 

  

    public static void main(String[] args) { 

        new GetTxt(REMOTE_FILE_URL, LOCAL_FILE_PATH).download(); 
    ...
    public GetTxt(String remoteFileUrl, String localFilePath) { 
